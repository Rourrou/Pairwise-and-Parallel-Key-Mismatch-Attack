 ...
 * Name:        byte2bit
 *
 * Description: Convert byte to bit
 *
 * Arguments:   - int *b:           pointer to output bit array
 *              - unsigned char *B: pointer to input byte array
 *                                  (of KYBER_POLYBYTES bytes)
 **************************************************/
void byte2bit(int b[KYBER_N], unsigned char B[KYBER_SYMBYTES])
{
  int16_t mask;
 ...
 * Name:        dec2byte
 *
 * Description: Convert Decimal to byte(2^8) with fixed length
 *
 * Arguments:   - int *b:           pointer to output bit array
 *              - unsigned char *B: pointer to input byte array
 *                                  (of KYBER_POLYBYTES bytes)
 **************************************************/
void dec2byte(int d, unsigned char *h, int len)
{
  int decimal_number = d;
  for (int i = 0; decimal_number > 0 && i < len; i++)
  {
    h[len - 1 - i] = decimal_number % 256;
 ...
 * Name:        dec2bit
 *
 * Description: Convert Decimal to binary with fixed length
 *
 * Arguments:   - int *b:           pointer to output bit array
 *              - unsigned char *B: pointer to input byte array
 *                                  (of KYBER_POLYBYTES bytes)
 **************************************************/
void dec2bit(int d, unsigned char *h, int len)
{
  int decimal_number = d;
  for (int i = 0; decimal_number > 0 && i < len; i++)
  {
    h[len - 1 - i] = decimal_number % 2;
